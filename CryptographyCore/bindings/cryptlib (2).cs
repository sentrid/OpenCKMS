...
public class crypt
{
	...
	****************************************************************************/
	...
	public const int CompliancelevelOblivious    = 0,
	Public Const Int CompliancelevelReduced      = 1,
	Public Const Int CompliancelevelStandard     = 2,
	Public Const Int CompliancelevelPkixPartial = 3,
	Public Const Int CompliancelevelPkixFull    = 4,
	Public Const Int CompliancelevelLast         = 5
	
	/* Flags for the Netscape netscape-cert-type extension */
	
	public const int NsCertTypeSslclient                    = 0X001;
	Public Const Int NsCertTypeSslserver                    = 0X002;
	Public Const Int NsCertTypeSmime                        = 0X004;
	Public Const Int NsCertTypeObjectsigning                = 0X008;
	Public Const Int NsCertTypeReserved                     = 0X010;
	Public Const Int NsCertTypeSslca                        = 0X020;
	Public Const Int NsCertTypeSmimeca                      = 0X040;
	Public Const Int NsCertTypeObjectsigningca              = 0X080;
	Public Const Int NsCertTypeLast                         = 0X100; // Last possible value
	
	/* Flags for the SET certificate-type extension */
	
	public const int SetCertificateTypeCard                        = 0x001,
	public const int SetCertificateTypeMer                         = 0x002,
	public const int SetCertificateTypePgwy                        = 0x004,
	public const int SetCertificateTypeCca                         = 0x008,
	public const int SetCertificateTypeMca                         = 0x010,
	public const int SetCertificateTypePca                         = 0x020,
	public const int SetCertificateTypeGca                         = 0x040,
	public const int SetCertificateTypeBca                         = 0x080,
	public const int SetCertificateTypeRca                         = 0x100,
	public const int SetCertificateTypeAcq                         = 0x200,
	public const int SetCertificateTypeLast                        = 0x400 // Last possible value
	...
	public const int ClassificationUnmarked     = 0  ,
	public const int ClassificationUnclassified = 1  ,
	public const int ClassificationRestricted   = 2  ,
	public const int ClassificationConfidential = 3  ,
	public const int ClassificationSecret       = 4  ,
	public const int ClassificationTopSecret   = 5  ,
	public const int ClassificationLast         = 255,
	...
	public const int SSLOPTION_MinimumVersionSslv3            = 0x000, // Min.protocol version
	public const int SSLOPTION_MinimumVersionTls10            = 0x001,
	public const int SSLOPTION_MinimumVersionTls11            = 0x002,
	public const int SSLOPTION_MinimumVersionTls12            = 0x003,
	public const int SSLOPTION_MinimumVersionTls13            = 0x004,
	public const int SSLOPTION_ManualCertificateCheck         = 0x008, // Require manual cert.verif.
	public const int SSLOPTION_DisableNameVerify              = 0x010, // Disable cert hostname check
	public const int SSLOPTION_DisableCertificateVerify       = 0x020, // Disable certificate check
	public const int SSLOPTION_SuiteB128                      = 0x100, // SuiteB security levels (may
	public const int SSLOPTION_SuiteB256                      = 0x200 // vanish in future releases)
