...
namespace OpenCKMS
{
    ...
    public class KeyMetadata
    {
        ...
        /// (i.e., cryptanalyze) the cryptographic algorithm. For example, for a TDEA key of 168 bits 
        ...
        /// </summary>
        /// <value>The access contro list.</value>
        public List<string> AccessControList { get; set; }
